    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of sn(e))
        !rn.call(s, i) &&
          ...
          pe(s, i, {
            get: () => e[i],
            enumerable: !(n = nn(e, i)) || n.enumerable,
          });
    return s;
  };
var ln = (s, e, t) => (
...
var xe = x((ms, tt) => {
  ...
  tt.exports = {
    ...
    MAX_SAFE_BUILD_LENGTH: mn,
    MAX_SAFE_INTEGER: dn,
    RELEASE_TYPES: hn,
    SEMVER_SPEC_VERSION: gn,
  ...
  var Tn = (F.re = []),
    ...
    y = (s, e, t) => {
      ...
      (wn(s, i, e),
        ...
        (h[i] = e),
        (yn[i] = n),
        (Tn[i] = new RegExp(e, t ? "g" : void 0)),
        (En[i] = new RegExp(n, t ? "g" : void 0)));
    };
...
var it = x((hs, st) => {
  "use strict";
  var In = Object.freeze({ loose: !0 }),
    Nn = Object.freeze({}),
    An = (s) => (s ? (typeof s != "object" ? In : s) : Nn);
  st.exports = An;
});
var lt = x((fs, at) => {
  "use strict";
  var ot = /^[0-9]+$/,
    ...
    Cn = (s, e) => rt(e, s);
  at.exports = { compareIdentifiers: rt, rcompareIdentifiers: Cn };
});
var we = x((bs, ct) => {
  "use strict";
  var me = $e(),
...
var Ue = x((ws, dt) => {
  "use strict";
  var gt = we(),
    kn = (s, e, t) => new gt(s, t).compare(new gt(e, t));
  dt.exports = kn;
});
var ht = x((Ts, mt) => {
  "use strict";
...
var Kt = x((v) => {
  ...
  async function jt(s) {
    let e = window.app,
      { vault: t } = e,
      n = window.moment,
      { template: i, format: o, folder: a } = re(),
      [c, u] = await Y(i),
      g = s.format(o),
      m = await ge(a, g);
    try {
  ...
  function Wn(s) {
    return Xn().indexOf(s.toLowerCase());
  }
  async function zt(s) {
    let { vault: e } = window.app,
      { template: t, format: n, folder: i } = ae(),
      [o, a] = await Y(t),
      c = s.format(n),
      u = await ge(i, c);
    try {
  ...
  function ls(s, e) {
    return { day: jt, month: qt, week: zt }[s](e);
  }
  v.DEFAULT_DAILY_NOTE_FORMAT = qe;
  v.DEFAULT_MONTHLY_NOTE_FORMAT = Mt;
  v.DEFAULT_QUARTERLY_NOTE_FORMAT = Vt;
  v.DEFAULT_WEEKLY_NOTE_FORMAT = Ye;
  v.DEFAULT_YEARLY_NOTE_FORMAT = Ut;
  v.appHasDailyNotesPluginLoaded = rs;
  v.appHasMonthlyNotesPluginLoaded = Xt;
  v.appHasQuarterlyNotesPluginLoaded = Wt;
  v.appHasWeeklyNotesPluginLoaded = Yt;
  v.appHasYearlyNotesPluginLoaded = Jt;
  v.createDailyNote = jt;
  v.createMonthlyNote = qt;
  v.createPeriodicNote = ls;
  v.createQuarterlyNote = es;
  v.createWeeklyNote = zt;
  v.createYearlyNote = ss;
  v.getAllDailyNotes = Yn;
  v.getAllMonthlyNotes = Zn;
  v.getAllQuarterlyNotes = ns;
  v.getAllWeeklyNotes = Kn;
  v.getAllYearlyNotes = os;
  v.getDailyNote = qn;
  v.getDailyNoteSettings = re;
  v.getDateFromFile = X;
  v.getDateFromPath = zn;
  v.getDateUID = $;
  v.getMonthlyNote = Qn;
  v.getMonthlyNoteSettings = le;
  v.getPeriodicNoteSettings = as;
  v.getQuarterlyNote = ts;
  v.getQuarterlyNoteSettings = ue;
  v.getTemplateInfo = Y;
  v.getWeeklyNote = Jn;
  v.getWeeklyNoteSettings = ae;
  v.getYearlyNote = is;
  v.getYearlyNoteSettings = ce;
});
var us = {};
an(us, { default: () => ke });
module.exports = un(us);
var en = require("obsidian");
var k = require("obsidian");
var J = require("obsidian"),
  Se = class extends J.Modal {
    constructor(t, n) {
      super(t.app);
      this.resolve = n;
      this.isConfirmed = !1;
...
var ye = (s) => {
  ...
  wt = ["ghp_", "github_pat_"],
  Fn = /^(gh[ps]_[a-zA-Z0-9]{36}|github_pat_[a-zA-Z0-9]{22}_[a-zA-Z0-9]{59})$/,
  Tt = async (s, e) => {
  ...
  showValidTokenInfo(e) {
    ...
    if (
      ...
      (i = e.currentScopes) != null &&
        i.length &&
        t.createDiv({
          text: `Scopes: ${e.currentScopes.join(", ")}`,
      ...
      a < 7 &&
        t.createDiv({
          text: `\u26A0\uFE0F Token expires in ${a} days`,
...
function Lt({ prependText: s, url: e, text: t, appendText: n }) {
...
var kt = require("obsidian"),
  Ie = class extends kt.SuggestModal {
    ...
    renderSuggestion(e, t) {
      t.createEl("div", {
        text: `${e.version} ${e.prerelease ? "(Prerelease)" : ""}`,
      });
    }
...
async function Ne() {
  try {
    let s = await (0, St.requestUrl)(`https://obsidian.md/?${Math.random()}`);
        ...
        let b = async () => {
          ...
          if (
            (d &&
              ((p.brat = {
                isIncompatible: !0,
                minAppVersionOriginal: p.minAppVersion,
              }),
...
The plugin has been registered with BRAT.`;
          ...
          if (Dt(C, N) === -1) {
            ...
            if (R === null) return !1;
            if (n) {
              let W = `There is an update available for ${l.id} from version ${T.version} to ${l.version}. `;
              return (
                await this.plugin.log(
                  `${W}[Release Info](https://github.com/${e}/releases/tag/${l.version})`,
                  !0,
                ),
                E(this.plugin, W, 30, () => {
                  l &&
...
var ne = async (s, e, t) => {
    ...
    let i = await Pt(e, s.settings.debuggingMode);
    if (!i)
      return (
        E(
          s,
    ...
    let o = await JSON.parse(i),
      a = (0, _.normalizePath)(Vn(s) + o.name),
...
${n}`,
    ...
    for (let o of s.settings.themesList) {
      let a = await Z(o.repo, !0, s.settings.debuggingMode);
      (a === "0" && (a = await Z(o.repo, !1, s.settings.debuggingMode)),
        console.log("BRAT: lastUpdateOnline", a),
        a !== o.lastUpdate && (await ne(s, o.repo, !1)));
    }
  ...
  Vn = (s) => `${(0, _.normalizePath)(`${s.app.vault.configDir}/themes`)}/`;
...
async function _n(s, e) {
  try {
    let t = `${s.vault.configDir}/plugins/obsidian42-brat/${$t}.json`,
      n = { appliedMigrations: [] };
    try {
...
var B = class extends H.Modal {
  ...
  async submitForm() {
    ...
    (await ne(this.plugin, e, !0)) && this.close();
  }
  onOpen() {
...
var Bt = require("obsidian"),
  S = class extends Bt.FuzzySuggestModal {
    constructor(t) {
      super(t.app);
      this.data = [];
...
Plugin reloading .....`,
      ...
      },
      {
        ...
        showInRibbon: !0,
        callback: async () => {
          let e = await yt(this.plugin.settings.debuggingMode);
          if (e) {
  ...
  constructor(e) {
    ...
    this.themes = {
      ...
      grabChecksumOfThemeCssFile: async (e, t = !1) =>
        await Z(e, t, this.plugin.settings.debuggingMode),
      grabLastCommitDateForFile: async (e, t) => await Rt(e, t),
    };
    this.plugin = e;
  }
};
...
async function Zt(s, e, t = !1) {
  if (
    ...
    let n = `${s.settings.loggingPath}.md`,
      i = `[[${(0, de.moment)()
        .format((0, Qt.getDailyNoteSettings)().format)
        .toString()}]] ${(0, de.moment)().format("HH:mm")}`,
      o = window.require("os"),
      a = de.Platform.isDesktop ? o.hostname() : "MOBILE",
      c = `${i} ${a} ${e.replace(
        `
`,
        " ",
...
var ke = class extends en.Plugin {
  constructor() {
    super(...arguments);
    this.APP_NAME = "BRAT";
    this.APP_ID = "obsidian42-brat";
    this.settings = je;
    this.betaPlugins = new te(this);
    this.commands = new se(this);
    this.bratApi = new ie(this);
