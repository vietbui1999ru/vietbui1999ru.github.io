    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of or(e))
        !ar.call(s, i) &&
          ...
          Bt(s, i, {
            get: () => e[i],
            enumerable: !(n = rr(e, i)) || n.enumerable,
          });
    return s;
  };
...
function No(s) {
  ...
  return {
    lineCounter: s.lineCounter || (e && new Pt()) || null,
    prettyErrors: e,
  };
}
function An(s, e = {}) {
...
`),
  ...
  onload() {
    (this.registerEvent(
      ...
      this.register(
        ve(document, "contextmenu", ".tag-pane-tag", this.onMenu.bind(this), {
          capture: !0,
        }),
      ),
      this.app.workspace.registerHoverLinkSource(nr, {
        display: "Tags View",
        defaultMod: !0,
      }),
      this.addChild(
    ...
    (this.register(
      ve(document.body, "dragover", ".tag-pane-tag.tree-item-self", t, {
        capture: !0,
      }),
    ),
      this.register(
        ve(document.body, "dragenter", ".tag-pane-tag.tree-item-self", t, {
          capture: !0,
        }),
      ),
